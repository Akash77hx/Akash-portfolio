...
const Head = () => {
    ...
    const meta = {
        title: `Akash.77 ${pathname === "/" ? "" : "• " + title.replace(/[-/]/g, " ")}`,
        ...
        keywords: "Akash.77, Web Developer, Software Engineer, Full Stack Developer",
        type: "website",
    };
    ...
    return (
        <>
            ...
            <link rel='me' href='mailto:akashkanojiya11220@gmail.com' />
            <meta property='og:type' content={meta.type} />
            <meta property='og:site_name' content='Akash.77' />
